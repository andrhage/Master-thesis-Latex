...
\Cref{eq:iou_1} and \cref{eq:iou_2} is described with the values taken from the confusion matrix which makes the equations easier to understand for those which are more familiar with reading results from confusion matrices.  
