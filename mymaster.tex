...
%Mostly of the theory in this section is based on the course notes from the Stanford University course \textit{"CS231n: Convolutional Neural Networks for Visual Recognition"}\cite{website:cs231n}.
...
% McCulloch & Pitts (1943) are generally recognised as the designers of the first artificial neural network. • Many of their ideas still used today (e.g.many simple units combine to give increased computational power and the idea of a threshold).
