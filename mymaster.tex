...
When the first line is executed, the \ac{gui} for \textit{labelme} shows up in an external window. From there it is possible to start drawing the annotation by pressing the \textit{"Create Polygons"}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{bilder/labelme_gui.png}
    \caption{The \ac{gui} for labelme}
    \label{fig:gui}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{The ground truth superimposed on the original image}
