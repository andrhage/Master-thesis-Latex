...
\label{table:dataset}
\end{table}
\todo{Skriv her om hva oppgaven går ut på. Dvs At du har to custom datasett uten noen ground truths, og prøver å predikere automatiske ground truths til de tilhørende datasettene, det bør være en slags repitisjon fra innledningen}
